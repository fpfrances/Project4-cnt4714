...
<html>
    ...
    <body style="background-color: black;">
        <div style="text-align: center;">
            ...
            <hr>
            <p>You are connected to the Project 4 Enterprise System database as a <mark class = "red">client-level</mark> user.</p>
            <p>Please enter any valid SQL query or update command in the box below.</p>
	    <br>
            <form action="/Project4/ClientUserServlet" method="post">
